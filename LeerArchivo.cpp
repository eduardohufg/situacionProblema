...
int main(int argc, char const *argv[])
{
    ...
    while (true)
    {
        ...
        case 1:
            ...
            cout << "En caso de que no se encuentre en la misma carpeta, especifica la ruta" << endl
                 << endl;
        ...
        case 3:
            ...
            for (int i = 0; i < videos.size(); i++)
            {
                ...
                Episodio *apuntS = dynamic_cast<Episodio*>(videos[i]);
                if (apuntS != 0)
                {
                    if (apuntS->getNombreVideo()==seri)
                    {
                        cout << "---------------------------------------------------------------" << endl;
                        apuntS->mostrarDatos();
                    }
        ...
        case 6:
            ...
            for(int i=0; i<videos.size();i++){
                ...
                if (apuntE!= 0)
                {
                    if (apuntE->getNombreVideo() == arch)
                    {
                        contaduracion = contaduracion + apuntE->getDuracion();
                        contasize++;
                    }
                }
            ...
            cout<<"La duracion promedio es: "<< contaduracion/contasize;
